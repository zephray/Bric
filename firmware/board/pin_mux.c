...
- {pin_num: '37', pin_signal: PIO0_9/FC3_SSEL2/SD0_POW_EN/FC5_TXD_SCL_MISO_WS/SECURE_GPIO0_9/ACMP0_B, label: SD_PWR_EN, identifier: SD_PWR_EN}
...
- {pin_num: '39', pin_signal: PIO1_1/FC3_RXD_SDA_MOSI_DATA/CT_INP3/SCT_GPI5/HS_SPI_SSEL1/USB1_OVERCURRENTN/PLU_OUT4, label: EPD_RST, identifier: EPD_RST}
...
- {pin_num: '50', pin_signal: PIO0_22/FC6_TXD_SCL_MISO_WS/UTICK_CAP1/CT_INP15/SCT0_OUT3/USB0_VBUS/SD1_D0/PLU_OUT7/SECURE_GPIO0_22, label: SW_SEL, identifier: SW_SEL}
...
- pin_list:
  ...
  - {pin_num: '37', peripheral: GPIO, signal: 'PIO0, 9', pin_signal: PIO0_9/FC3_SSEL2/SD0_POW_EN/FC5_TXD_SCL_MISO_WS/SECURE_GPIO0_9/ACMP0_B, direction: OUTPUT, gpio_init_state: 'true'}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t EPD_RST_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO1_1 (pin 39)  */
    GPIO_PinInit(BOARD_INITPINS_EPD_RST_GPIO, BOARD_INITPINS_EPD_RST_PORT, BOARD_INITPINS_EPD_RST_PIN, &EPD_RST_config);
