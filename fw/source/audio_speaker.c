 ...
 * Definitions
 ******************************************************************************/
#define DEMO_I2S_MASTER_CLOCK_FREQUENCY (11289600)
#define DEMO_I2S_TX (I2S7)
#define DEMO_DMA (DMA0)
#define DEMO_I2S_SAMPLE_SIZE (16)
#define DEMO_I2S_FRAME_SIZE (64)
#define DEMO_I2S_TX_CHANNEL (19)
#define I2S_CLOCK_DIVIDER (DEMO_I2S_MASTER_CLOCK_FREQUENCY / AUDIO_SAMPLING_RATE / DEMO_I2S_FRAME_SIZE)

#define AUDIO_SAMPLING_RATE_TO_10_14 (((AUDIO_SAMPLING_RATE/1000)<<14)|((AUDIO_SAMPLING_RATE%1000)<<4))
...
usb_audio_speaker_struct_t g_UsbDeviceAudioSpeaker = {
    ...
    .copyProtect          = 0x01U,
    .curMute              = 0x00U,
    .curVolume            = {0x1fU, 0x00U},
    .minVolume            = {0x00U, 0x00U},
    .maxVolume            = {0xffU, 0x00U},
...
void I2S_USB_Audio_TxInit(I2S_Type *SAIBase)
{
    ...
    s_TxConfig.dataLength = DEMO_I2S_SAMPLE_SIZE;
    s_TxConfig.frameLength = DEMO_I2S_FRAME_SIZE;
...
void USB_DeviceClockInit(void)
{
    ...
    USB_EhciPhyInit(CONTROLLER_ID, 24000000U, NULL);
...
void USB_AudioCodecTask(void)
{
    ...
    if (g_UsbDeviceAudioSpeaker.codecTask & VOLUME_CHANGE_TASK)
    {
        ...
        CS43130_SetVolume(g_UsbDeviceAudioSpeaker.curVolume[0]);
#endif
        g_UsbDeviceAudioSpeaker.codecTask &= ~VOLUME_CHANGE_TASK;
    }
}
